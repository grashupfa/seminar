...
\node [circle,draw] (0) {0}
    child 
    {
        ...
        child 
        {
            ...
            child
            {
                node (d1) {\die1} edge from parent node[above left]{0.5}
            }
            edge from parent node[above left]{0.5}
        }
        child 
        {
            node [circle,draw] (4) {4}
            child 
            {
                node (d2) {\die2} edge from parent node[above left]{0.5}
            }
            child 
            {
                node (d3) {\die3} edge from parent node[above right]{0.5}
            }
  ...
  child 
  {
    ...
    child 
    {
        ...
        child 
        {
            node (d4) {\die4} edge from parent node[above left]{0.5}
        }
        child 
        {
            node (d5) {\die5} edge from parent node[above right]{0.5}
        }
        edge from parent node[above left]{0.5}
    }
    child 
    {
        node [circle,draw] (6) {6}
        child 
        {
            node (d6) {\die6} edge from parent node[above right]{0.5}
        }
        edge from parent node[above right]{0.5}
    }
    edge from parent node[above right]{0.5}
